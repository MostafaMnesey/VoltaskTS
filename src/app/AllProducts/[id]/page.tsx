...
// ✅ SSG params - this remains the same
...
// ✅ Updated Page Component - params is now async
export default async function ProductDetails({
  params,
}: {
  params: Promise<{ id: string; slug: string }>; // Changed to Promise
}) {
...
// Optional: Add generateMetadata if you want SEO optimization
